    ...
    <footer className="footer-wrapper" ref={footerRef}>
      ...
      <div className="footer-content">
        ...
        <div className="footer-socials">
          <h3 className="footer-heading footer-anim">CONNECT</h3>
          <div className="social-pills footer-anim">
            <a href="https://www.instagram.com/kamalakkannan_durairaju/?utm_source=ig_web_button_share_sheet" className="social-pill" title="Instagram">
            ...
            {/*<a href="#" className="social-pill" title="X (Twitter)">
              <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor">
                <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/>
              </svg>
            </a>*/}
            <a href="https://www.linkedin.com/in/kamalakkannan-durairaju-565892101?utm_source=share_via&utm_content=profile&utm_medium=member_android" className="social-pill" title="LinkedIn">
              <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor">
